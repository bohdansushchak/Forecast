...
private const val MY_PERMISSION_ACCESS_COARSE_LOCATION = 0x1
...
class MainActivity : AppCompatActivity(), KodeinAware {
    ...
    private val locatiobCallback = object : LocationCallback() {
    ...
    private fun bindLocationManager() {
        LifecycleBoundLocationManager(this,
            fusedLocationProviderClient, locatiobCallback)
    }
